    ...
    public partial class initial1 : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        DeletedUser = c.Int(nullable: false),
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Subjects", t => t.ParentSubjectId)
                .ForeignKey("dbo.User", t => t.UserId, cascadeDelete: true)
                .Index(t => t.ParentSubjectId)
                .Index(t => t.UserId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Subjects", "UserId", "dbo.User");
            DropForeignKey("dbo.UserRole", "UserId", "dbo.User");
            DropForeignKey("dbo.UserLogin", "UserId", "dbo.User");
            DropForeignKey("dbo.UserClaim", "UserId", "dbo.User");
            DropForeignKey("dbo.Subjects", "ParentSubjectId", "dbo.Subjects");
            ...
            DropIndex("dbo.Subjects", new[] { "ParentSubjectId" });
